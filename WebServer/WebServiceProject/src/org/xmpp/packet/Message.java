...
public class Message extends Packet {
    ...
    public enum Type {
        ...
        headline,
        /**
         * Used for identifying users on Partyspam.
         */
        identity,
        /**
         * Used for creating events on Partyspam.
         */
        createEvent,
        /**
         * Used for retrieving events around you.
         */
        getEvents,
        /**
         * Used for signaling a change in client position.
         */
        updatePosition,
        /**
         * Notifies the component about the user attending a certain party.
         */
        attendEvent,
        /**
         * Tell the component that you want updates for the given parties.
         */
        refreshEvents,
        /**
         * Tell the client about the events that no longer exist.
         */
        deletedEvents,
        /**
         * Tell the client about the event that was updated.
         */
        updatedEvent,
